...
plant1 = Plant.new(name: 'Tomato',
                   ...
                   warm-season crop that needs about a three-month growing season to reach fruit-producing stage.',
...
plant2 = Plant.new(name: 'Cucumber',
                   ...
                   crosspollination to produce fruits. Fruits should be ready for picking 8-10 weeks after sowing. Pick
                   regularly, before the pips start to harden. Cucumbers are used in salads and sandwich fillings.',
                   ...
                   near beans, lettuces, radishes and green peppers. Also, they release a root secretion which inhibits
                   weeds. They are creeping vines that generally need a trellis or supporting frame, but can also be
                   grown in rows or basins 300mm across and ±1m apart.')
...
plant3 = Plant.new(name: 'Strawberry',
                   description: 'Strawberries are very adaptable and will grow almost everywhere, although the flavour
                   is best in cooler climates. Ideal for small gardens, as they need little space and can be grown in
                   containers. Always buy plants certified as virus-free.',
                   scientific_name: 'Fragaria x ananassa', origin: 'Northen Europe',
                   instruction: 'Plant 250mm apart in rows, leaving 600mm between rows. Plant in autumn to ensure a good
                   crop in early summer. use compost- enriched soil and mulch to preserve soil moisture. Water regularly
                   and feed once a month with liquid fertilizer during the active growing season.')
...
plant4 = Plant.new(name: 'Pumpkin',
                   description: 'Pumpkins, squash, marrows and courgettes (baby marrows) all fall into the same group of
                   easy-to grow, warm-season crops. Pumpkins are rampant growers and not ideal for smaller gardens as
                   they take up too much space. The flowers are also edible and can be added to dishes as flavouring.',
                   scientific_name: 'Cucurbita maxima', origin: 'North and South America',
                   instruction: 'For pumpkins, plant six to eight seeds 20mm deep in soil basins 300mm in diameter and
                   2m apart; well-enriched soil with good drainage is best. Plant near mealies, beans and radishes. also
                   plant garlic and chives near them, this helps with mildew.')
...
plant5 = Plant.new(name: 'Garlic',
                   description: 'A perennial plant, consisting of a clump of flat leaves, round pinkish flowerheads and
                   a compound bulb divided into cloves, each covered in a white or mottled purple, parchment-like skin.
                   It is a close relative of the onion. Garlic is a natural antibiotic, an antiseptic, a blood tonic,
                   toner and cleanser.',
                   ...
                   apart. This plant relies on well-prepared soil. Seed can be sown in trays filled with sand in spring
                   or autumn. Keep moist and protected until strong enough to handle.')
...
plant6 = Plant.new(name: 'Coriander',
                   ...
                   parsley-like leaves and small white or purplish-tinged flowers. The leaves, which have a distinctive
                   taste, are known by various culinary terms, including coriander, dhania, cilantro and Chinese
                   parsley. An annual herb with dark green, parsley-like leaves',
                   ...
                   so don\'t grow these plants near each other. It can be placed in a large pot on a veranda or patio.')
...
plant7 = Plant.new(name: 'Peppermint',
                   ...
                   excellent for flavouring ice-creams, chocolate desserts and cakes. Commercially extracted peppermint
                   oil is used to flavour confectionery.',
                   ...
                   climate with well-draining, loose, organically-rich soil. Keep the area around your mint free of
                   weeds.')
...
plant8 = Plant.new(name: 'Thyme',
                   description: 'A woody, low-growing plant with stiff stems covered in strongly aromatic, small, oval
                   greygreen leaves. It has small clusters of lilac flowers. A popular culinary herb, used in stews for
                   its strong delicious flavour. Thymol oil, can be used to chase fleas, flies, mosquitoes and ants. It
                   is also used for perfumes and medicines.',
                   scientific_name: 'Thymus vulgaris', origin: 'Mediterranean regions',
                   instruction: 'Ideal for pots in full sun. Thyme planted along pathways and around vegetable gardens,
                   keeps out insects.')
...
plant9 = Plant.new(name: 'Baobab',
                   description: 'This extraordinary tree, from the drier northern parts of South Africa, looks as if it
                   has been planted upside down. It bears waxy white flowers which are followed by large, egg-shaped
                   fruits covered in fine hair. The short-lived flowers open in the late afternoon and decline within 24
                   hours. Baobabs are notable for their huge trunk circumference and heavily folded bark, in shades of
                   grey, reddish brown or copper.',
...
plant10 = Plant.new(name: 'Flamboyant',
                    ...
                    magnificent, flowering shade tree with a large, flat top that is covered with striking, orange-red
                    flowers in summer.',
                    scientific_name: 'Delonix regia', origin: 'Madagascar',
                    instruction: 'Flame trees are propagated from seed. Let the dry seeds swell in lukewarm water for a
                    few days before you put them in cultivation soil. Keep them at a steady temperature of 68° F / 20°C.
                    It will take about three weeks until the seeds germinate.')
...
plant11 = Plant.new(name: 'Pod Mahogany',
                    description: 'A handsome tree with a spreading crown. Sprays of pinkish-red flowers appear in early
                    summer, followed by large, woody pods with attractive seeds. Tolerates salt-laden winds.',
                    scientific_name: 'Afzelia quanzensis', origin: 'Southern Africa',
                    instruction: 'Plant mahogany in full sun with plenty of room to spread. They are highly salt and
                    drought tolerant and do well in coastal areas. Mahoganies grow to become large trees with aggressive
                    roots. Generally, plant them no closer than 20 feet from permanent structures and 5 to 6 feet from
                    sidewalks and curbs.')
...
plant12 = Plant.new(name: 'Alexandra palm, king palm',
                    ...
                    instruction: 'Dig a hole. It should be at least 6 inches larger than the width of the container and
                    deep enough to cover the root ball with 2 to 3 inches of soil. About 2 to 4 inches of sand in the
                    bottom of the hole will ensure proper drainage. If planting multiple trees, leave at least 20 feet
                    between each. Place your young palm in the center of the hole and fill it with a mixture of 50
                    percent sand and 50 percent original soil.')
